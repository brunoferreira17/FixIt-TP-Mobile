...
## Current Status
The first submission is nearly complete, including:
- Active Git repository with initial code.
- Trello board for task management.
- Requirements document.
- Mockups and logo supporting PT/EN and portrait/landscape.
- Database schema with diagram (pending final upload).
